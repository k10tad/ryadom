const VERSION = 'ryadom-v1.9.1-otc-search-recovery';
const APP_SHELL = [
  './',
  './index.html',
  './css/style.css?v=1.9.1',
  './css/cycle-tracker.css?v=1.6.0',
  './css/style-v050.css?v=1.8.23',
  './css/splash.css?v=1.0.2',
  './manifest.webmanifest',
  './js/splash.js?v=1.0.0',
  './js/app.js?v=1.9.1',
  './js/config.js?v=1.9.1',
